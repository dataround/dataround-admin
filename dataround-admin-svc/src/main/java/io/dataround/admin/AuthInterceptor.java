...
import static io.dataround.admin.common.CookieUtils.EXPIRATION_TIME;
import static io.dataround.admin.common.CookieUtils.REFRESH_THRESHOLD;
...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws ServletException {
        try {
            ...
            UserInfo user = JwtUtil.verifyToken(value, remoteIp);
